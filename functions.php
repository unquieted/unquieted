...
function unquieted_setup() {
	...
	add_image_size( 'unquieted-full-bleed', 2000, 1200, true );
	add_image_size( 'unquieted-index-img', 1000, 550, true );
	...
	/* Editor styles */
	add_editor_style( array( 'inc/editor-styles.css', unquieted_fonts_url() ) );
}
endif;
...
function unquieted_fonts_url() {
	...
	$pt_serif = _x( 'on', 'PT Serif font: on or off', 'unquieted' );
        ...
        $roboto_mono = _x( 'on', 'Roboto Mono font: on or off', 'unquieted' );
	...
	if ( 'off' !== $pt_serif ) {
        ...
        if ( 'off' !== $roboto_mono ) {
                $font_families[] = 'Roboto+Mono:400,400i,800';
        }

        if ( in_array( 'on', array($source_sans_pro, $pt_serif, $codystar_display, $roboto_mono) ) ) {
...
function unquieted_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add sidebar widgets here.', 'unquieted' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Page Sidebar', 'unquieted' ),
		'id'            => 'sidebar-2',
		'description'   => esc_html__( 'Add page sidebar widgets here.', 'unquieted' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Widgets', 'unquieted' ),
		'id'            => 'footer-1',
		'description'   => esc_html__( 'Add footer widgets here.', 'unquieted' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
